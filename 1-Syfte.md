...
Den behandlande praktiken i psykiatrisk vård -- till exempel bedömning, utredning, stödsamtal, psykoterapi, psykoedukation -- kringgärdas av ett flertal *diskurser*. Med diskurser menas här de kulturella meningssystem eller "sätt att tala om" en viss företeelse som gör att företeelsen framstår förstås på ett visst sätt och inte ett annat \cite{Foucault2011,MagnussonMarecek2010}; i den bemärkelsen utgör psykiatrin själv en diskurs med därtill förknippade identiteter: läkare, patient, och så vidare. Flera av de i den psykiatriska praktiken närvarande diskurserna är till synes svåra att förena. Här finns till exempel:

* det *diagnostiska språket* som premierar en medicinsk och individuell förståelse av människors psykiska lidande \cite{Hallerstedt2006,Kaatari2013,Ohlsson2011}; 
* krav på *evidensbaserade behandlingsmetoder* som premierar en förståelse av såväl psykiskt lidande som behandling i termer av mätbarhet, effekt och symptomlindring \cite{Karlsson2011,Krogstrup2011,Levi2009}; 
* jättefina likabehandlingsplaner och krav på jämlikhet och mångfaldsarbete och annat fint som alla behandlare förväntas leva upp till (och så kan man förstås inte alls formulera det, men du förstår tankegången); 
* perspektiv som med utgångspunkt i den ojämna fördelningen av psykiatriska diagnoser mellan människor tillhörande olika sociala kategorier utifrån kön, sexuell läggning, etnicitet, socioekonomisk status etc betraktar psykiskt lidande som ett uttryck för samhälleliga strukturer; 
* sociokulturella perspektiv som med utgångspunkt i den stora historiska och kulturella variationen i uttryck för psykiskt lidande betraktar detta som något historiskt och kulturellt avhängigt; 
* och så vidare.
