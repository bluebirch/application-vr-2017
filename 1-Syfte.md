...
Den behandlande praktiken i psykiatrisk vård -- till exempel bedömning, utredning, stödsamtal, psykoterapi, psykoedukation -- kringgärdas av ett flertal *diskurser*. Med diskurser menas här de kulturella meningssystem eller "sätt att tala om" en viss företeelse som gör att företeelsen framstår förstås på ett visst sätt och inte ett annat \cite{Foucault2011,MagnussonMarecek2010}; i den bemärkelsen utgör psykiatrin själv en diskurs med därtill förknippade identiteter: läkare, patient, och så vidare. Flera av de i den psykiatriska praktiken närvarande diskurserna är till synes svåra att förena. Här finns till exempel det *diagnostiska språket* som premierar en medicinsk och individuell förståelse av människors psykiska lidande \cite{Hallerstedt2006,Kaatari2013,Ohlsson2011}; här finns krav på *evidensbaserade behandlingsmetoder* som premierar en förståelse av såväl psykiskt lidande som behandling i termer av mätbarhet, effekt och symptomlindring \cite{Karlsson2011,Krogstrup2011,Levi2009}; här finns jättefina likabehandlingsplaner och krav på jämlikhet och mångfaldsarbete och annat fint som alla behandlare förväntas leva upp till (och så kan man förstås inte alls formulera det, men du förstår tankegången); här finns perspektiv som med utgångspunkt i den ojämna fördelningen av psykiatriska diagnoser mellan människor tillhörande olika sociala kategorier utifrån kön, sexuell läggning, etnicitet, socioekonomisk status etc betraktar psykiskt lidande som ett uttryck för samhälleliga strukturer; här finns sociokulturella perspektiv som med utgångspunkt i den stora historiska och kulturella variationen i uttryck för psykiskt lidande betraktar detta som något historiskt och kulturellt avhängigt; och så vidare.

***

ramar av olika slag: organisatoriska, rumsliga, ekonomiska, och så vidare. Här intresserar vi oss framför allt för de *diskurser* som kringgärdar praktiken, alltså de kulturella meningssystem eller "sätt att tala om" en viss företeelse som gör att företeelsen förstås på ett visst sätt och inte ett annat sätt \cite{MagnussonMarecek2010}. Ett exempel på en sådan diskurs i psykiatriska sammanhang är det *diagnostiska språket* som premierar en medicinsk och individuell förståelse av människors psykiska lidande framför exempelvis en social, strukturell eller existentiell förståelse \cite{Hallerstedt2006,Kaatari2013,Ohlsson2011}. (Ett annat är strävan efter *evidensbaserade behandlingsmetoder* som premierar en förståelse av såväl psykiskt lidande som behandling i termer av mätbarhet, effekt och symptomlindring \cite{Karlsson2011,Krogstrup2011,Levi2009}.) I kontrast till dessa står diskurser där den psykiska ohälsan förstås som ett sociokulturellt eller strukturellt fenomen som är en del av av en specifik historisk och samhällelig kontext (Johannisson 2013 & 2015; Sveneaus 2015 & 2016; Hallerstedt 2006). De psykiatriska diagnosernas ojämna fördelning mellan människor tillhörande olika sociala kategorier utifrån exempelvis kön, sexuell läggning, etnicitet eller socioekonomisk situation, talar för relevansen av ett sådant perspektiv på psykisk ohälsa (Socialstyrelsen, 2013; Statens folkhälsoinstitut, 2005; Statens offentliga utredningar, 2006, 2015; Sveriges kommuner och landsting, 2014; Ungdomsstyrelsen, 2010).

 ... *någonting om just sociala/strukturella/existentiella förståelser och en hänvisning till att statistik visar hur diagnoser är snedfördelade avseende på ffa kön & socioekonomisk status/klass vilket antyder annat än medicinska/individuella förståelser av människors lidande*
